...
@interface MasterDetailViewManager()
...
@implementation MasterDetailViewManager
...
-(void)setDetailController:(UIViewController *)viewController{
    ...
    self.splitViewController.viewControllers = [NSArray arrayWithObjects:tabBarController,viewController, nil];
}
